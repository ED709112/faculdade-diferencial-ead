...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      { url: 'https://fadead.com.br/images/og-image.jpg', width: 1200, height: 630 },
      { url: 'https://fadead.com.br/images/students-hero.jpg', width: 612, height: 408 },
    ],
    locale: 'pt_BR',
    type: 'website',
  },
  twitter: {
    ...
    images: ['https://fadead.com.br/images/og-image.jpg'],
  },
};
